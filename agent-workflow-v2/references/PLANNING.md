...
valid state if later work never lands. Split independently provable risks; keep
together work whose separation creates an invalid intermediate state or hides the
