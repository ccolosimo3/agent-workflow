...
def main() -> int:
    ...
    append(args.output, {"program_id": scenario["scenario_id"], "event_type": "environment_attested", "task_id": "research", "payload": {"id": "environment-repair", "task_id": "research", "checkout": str(args.output.resolve()), "base": "pilot-base", "tip": "pilot-base", "assignment_generation": 1, "topology_revision": 1, "commands": [{"command": "offline-smoke", "result": "passed", "exit_code": 0, "output_sha256": hashlib.sha256(b"offline-smoke:passed").hexdigest()}], "ready": True, "dirty_state": "clean", "evidence": "isolated temporary directory"}})
